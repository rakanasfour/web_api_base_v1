...
public class CustomerServiceImpl {
	...
	public CustomerServiceImpl(UserRepository userRepository, UserMapperChannel userMapper,
    ...
    public ItemResponseDTO findItemByIdCustomer(Integer id) {
        return Optional.ofNullable(itemRepository.findItemByIdCustomer(id)) // Ensure null safety
