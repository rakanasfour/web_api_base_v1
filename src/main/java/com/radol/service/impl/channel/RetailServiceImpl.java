...
public class RetailServiceImpl {
	...
	public RetailServiceImpl(UserRepository userRepository, UserMapperChannel userMapper, ItemRepository itemRepository,
			ItemMapperChannel itemMapper, BrandRepository brandRepository, BrandMapperChannel brandMapper,
			ModelRepository modelRepository, ModelMapperChannel modelMapper, ChannelRepository channelRepository,
			ChannelMapperChannel channelMapper, UomRepository uomRepository, UomMapperChannel uomMapper,
			ClassRepository classRepository, ClassMapperChannel classMapper,
...
/*
    ...
    */
    ...
    public ItemResponseDTO findItemByIdRetail(Integer id) {
        return Optional.ofNullable(itemRepository.findItemByIdRetail(id)) // Handle null from query
                .map(itemMapper::toDTO)
                /*
                .map(itemDTO -> {
