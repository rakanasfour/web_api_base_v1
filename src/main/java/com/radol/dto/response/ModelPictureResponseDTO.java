...
public class ModelPictureResponseDTO {
	...
	public ModelPictureResponseDTO(Integer modelPictureId, String modelPictureName, String modelPictureLink, Integer modelId) {
		super();
	...
	public ModelPictureResponseDTO() {
		super();
