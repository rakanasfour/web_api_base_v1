...
public class ManufacturerPricingResponseDTO {
	  ...
	  private Integer pricingId;
	    ...
	    public ManufacturerPricingResponseDTO(Integer pricingId, BigDecimal pricingList, BigDecimal pricingMsrp,
		...
		public ManufacturerPricingResponseDTO() {
			super();
