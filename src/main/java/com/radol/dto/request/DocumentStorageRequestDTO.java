...
public class DocumentStorageRequestDTO {
	 ...
	 private Integer documentStorageId;
		...
		public DocumentStorageRequestDTO(Integer documentStorageId, String documentStorage1, Integer itemId) {
			super();
			this.documentStorageId = documentStorageId;
			this.documentStorage1 = documentStorage1;
			this.itemId = itemId;
		}
		public DocumentStorageRequestDTO() {
			super();
