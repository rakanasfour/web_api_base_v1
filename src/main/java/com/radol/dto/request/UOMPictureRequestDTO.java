...
public class UOMPictureRequestDTO {
    ...
    public UOMPictureRequestDTO(Integer uomPictureId, String uomPictureName, String uomPictureLink,
			Integer uomId) {
		super();
