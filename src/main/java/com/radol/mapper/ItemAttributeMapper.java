...
public interface ItemAttributeMapper extends EntityMapper<ItemAttributeDTO, ItemAttribute> {
    ...
    @Mapping(source = "mappedItemAttribute.itemType", target = "itemType")
    @Mapping(source = "mappedItemAttribute.itemQuantity", target = "itemQuantity")
    ...
    @Mapping(source = "mappedItemAttribute.itemBasePrice", target = "itemBasePrice")
    @Mapping(source = "mappedItemAttribute.itemWeight", target = "itemWeight")
