...
public interface ItemSalesCategoryMapper extends EntityMapper<ItemSalesCategoryDTO, ItemSalesCategory> {
	  ...
	  @Mapping(source = "mappedItemSalesCategory.itemId", target = "itemId")
	    ...
	    @Mapping(source = "mappedItemSalesCategory.itemType", target = "itemType")
	    @Mapping(source = "mappedItemSalesCategory.itemQuantity", target = "itemQuantity")
	    ...
	    @Mapping(source = "mappedItemSalesCategory.itemBasePrice", target = "itemBasePrice")
	    @Mapping(source = "mappedItemSalesCategory.itemWeight", target = "itemWeight")
